q_key = Questions(question="Who has the most rings in the NBA?",
                    choice1 ="Kobe Bryant",
...
q_key = Questions(question="Who is the only athlete ever to play in a Super Bowl and a World Series?",
...
q_key = Questions(question="What is the regulation height for a basketball hoop?",
                    choice1 ="8 feet",
                    choice2 ="12 feet",
                    choice3 ="5 feet",
                    choice4 ="10 feet",
...
q_key = Questions(question="How many stars are in the sky?",
                    choice1 ="5 billion",
                    choice2 ="3 thousand",
                    choice3 ="10 billion",
...
q_key = Questions(question="How many types of stars are there?",
                    choice1 ="3",
                    choice2 ="5",
                    choice3 ="12",
                    choice4 ="80",
...
q_key = Questions(question="=Who is Simba's father?",
                    choice1 ="Mufasa",
                    choice2 ="Scar",
...
q_key = Questions(question="How many soccer players should be on the field at the same time?",
                    choice1 ="22",
                    choice2 ="20",
                    choice3 ="15",
                    choice4 ="17",
...
q_key = Questions(question="What NFL Quarterback has been in the most Super Bowls?",
                    choice1 ="Joe Montana",
                    choice2 ="tom Brady",
                    choice3 ="Eli Manning",
...
q_key = Questions(question="Who was the first black baseball player to play in the major leagues?",
                    choice1 ="Derek Jeter",
...
q_key = Questions(question="Who broke the record for the fastest man alive in the 2008 Summer Olympics?",
                    choice1 ="Usain Bolt",
                    choice2 ="Tyreek Hill",
                    choice3 ="Tyson Gay",
...
q_key = Questions(question="How many gold medals does Michael Phelps have?",
                    choice1 ="28",
                    choice2 ="25",
                    choice3 ="23",
                    choice4 ="27",
...
q_key = Questions(question="How many total bases are there on a baseball field?",
                    choice1 ="1",
                    choice2 ="5",
                    choice3 ="4",
                    choice4 ="3",
...
q_key = Questions(question=" Which is the least popular sport in the World?",
                    choice1 ="Soccer",
                    choice2 ="Cricket",
                    choice3 ="Volleyball",
                    choice4 ="Basketball",
...
q_key = Questions(question="Who was the only President to serve more than two terms?",
...
q_key = Questions(question="Who was the only President to serve two non-consecutive terms?",
...
q_key = Questions(question="Who was the oldest elected President?",
...
q_key = Questions(question="Who was the first President born outside the contiguous United States?",
...
q_key = Questions(question="What American president is associated with the Teddy Bear?",
...
q_key = Questions(question="Which U.S. President signed the treaty to purchase Alaska from Russia?",
...
q_key = Questions(question="Who was the first President to appear on TV?",
...
q_key = Questions(question="Who was the first President to be impeached?",
                    choice1 ="Richard Nixon",
...
q_key = Questions(question="Who was the only unanimously elected President by the Electoral College?",
                    choice1 ="Franklin D Roosevelt",
                    choice2 ="George Washington",
...
q_key = Questions(question="How did Cinderalla lose her glass slipper?",
...
q_key = Questions(question="Why did Mulan join the military?",
...
q_key = Questions(question="How did Hiccup lose a leg?",
...
q_key = Questions(question="What is the biggest plant in our solor system?",
                    choice1 ="Jupiter",
                    choice2 ="Saturn",
                    choice3 ="Pluto",
                    choice4 ="The Sun",
...
q_key = Questions(question="What happends when a super giant explodes?",
...
q_key = Questions(question="how big is the milky way galaxy in light years?",
                    choice1 ="20,000",
                    choice2 ="100,000",
                    choice3 ="500,000",
                    choice4 ="no on knows",
...
q_key = Questions(question="Why did Kenai kill Koda's mom?",
